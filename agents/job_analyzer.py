...
class JobAnalyzer:
    ...
    def _validate_analysis(self, analysis: Dict[str, Any], raw_text: str) -> Dict[str, Any]:
        ...
        # Extra check for Company Name hallucination
    ...
    def analyze(self, job_description: str) -> Dict[str, Any]:
        ...
        2. Use EXACT keywords for ATS optimization
        ...
        # Pydantic Validation: Ensures entire structure is correct and contains expected types
        validated_data = JobAnalysis.model_validate(result).model_dump()
        
        # Extra hallucination check
        return self._validate_analysis(validated_data, job_description)
